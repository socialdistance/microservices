DATABASE_URL_FILE_SERVICE := "postgres://postgres:postgres@localhost:54321/lib_isod?sslmode=disable"
DATABASE_URL_AUTH_SERVICE := "postgres://postgres:postgres@localhost:54322/lib_isod_auth?sslmode=disable" 
